...
# Load assets
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('/Users/renuka/Documents/game_dev2/GD2-L6-oops-space-invaders', 'ship2.png'))
RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('/Users/renuka/Documents/game_dev2/GD2-L6-oops-space-invaders', 'ship1.png'))
SPACE = pygame.transform.scale(pygame.image.load(os.path.join('/Users/renuka/Documents/game_dev2/GD2-L6-oops-space-invaders','space.png')), (WIDTH, HEIGHT))
