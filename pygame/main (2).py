...
class Bin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('GD2-L10-Recycle Marathon/bin.png').convert_alpha()
...
class Non_recyclable(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('GD2-L10-Recycle Marathon/plastic.png').convert_alpha()
        self.image = pygame.transform.scale(self.image, (40,40))
        self.rect = self.image.get_rect()

#List of images for Recyclable class
images=["GD2-L10-Recycle Marathon/item1.png","GD2-L10-Recycle Marathon/item2.png","GD2-L10-Recycle Marathon/item3.png"]
...
while playing:
    ...
    if timeElapsed >=60:        
        ...
        # Change the background 
        changeBackground("GD2-L10-Recycle Marathon/bground.png")
